...
TEST_CASE("A non-empty environment replaces the file", "[mangoapp_config]") {
	REQUIRE_FALSE(mangoapp_config_visible("preset=2", "no_display"));
	REQUIRE(mangoapp_config_visible("no_display", "no_display=0"));
	REQUIRE(mangoapp_config_visible("no_display", "fps_limit=60"));
	REQUIRE_FALSE(mangoapp_config_visible("", "preset=0"));
}

TEST_CASE("With read_cfg the environment is applied on top of the file", "[mangoapp_config]") {
	REQUIRE_FALSE(mangoapp_config_visible("no_display", "read_cfg,fps_limit=60"));
	REQUIRE_FALSE(mangoapp_config_visible("no_display", "read_cfg=1"));
	REQUIRE(mangoapp_config_visible("no_display", "read_cfg=0"));
	REQUIRE(mangoapp_config_visible("no_display", "read_cfg,no_display=0"));
	REQUIRE_FALSE(mangoapp_config_visible("preset=2", "read_cfg,no_display"));
}
